...
const ContactInfoForm = () => {
  ...
  const translations = {
    vi: {
      ...
      sectionDescription: "Mỗi chia sẻ, mỗi thông tin là một nhịp điệu, một hòa âm cộng hưởng tạo lên cơn sóng, giúp AGUA hiểu rõ hơn về gia đình và định hướng học tập trong tương lai của con, để hành trình sắp tới được khởi đầu thật êm và đúng hướng",
    ...
    en: {
      ...
      sectionDescription: "Each share, each piece of information is a rhythm, a harmony that creates a wave, helping AGUA better understand your family and your child's future learning orientation, so that the upcoming journey can start smoothly and in the right direction",
