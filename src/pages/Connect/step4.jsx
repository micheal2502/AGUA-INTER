...
const ContactStep4 = () => {
  ...
  const translations = {
    vi: {
      ...
      heroSubtitle: "Cùng xây dựng nền tảng vững chắc cho hành trình học tập hạnh phúc",
      processFeatures: [
        "Đồng hành lâu dài",
      ...
      sectionDescription: "Khi hành trình đã đi qua những đợt sóng lớn, đây là lúc chúng ta lắng lại để hiểu rõ hơn cách anh/chị mong muốn đồng hành cùng con và cùng AGUA kiến tạo một không gian học tập hạnh phúc, bền vững.",
    ...
    en: {
      ...
      heroSubtitle: "Together building a solid foundation for a happy learning journey",
      processFeatures: [
      ...
      sectionDescription: "When the journey has passed through the big waves, this is the time for us to calm down to better understand how you want to accompany your child and work with AGUA to create a happy, sustainable learning space.",
